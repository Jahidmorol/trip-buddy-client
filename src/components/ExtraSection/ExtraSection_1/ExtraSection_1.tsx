    ...
    <div className="py-9">
      ...
      <div className="flex flex-col-reverse md:flex-row gap-5 md:gap-0 items-center justify-evenly py-0">
        <div className="space-y-7">
          <div className="flex items-center gap-4 py-2 text-white transition-all ease-in-out hover:text-[#E8604C] duration-300">
            <Image src={icon1} alt="es1" className="w-10 " />
            <div className="">
          ...
          <div className="flex items-center gap-4 py-2 text-white transition-all ease-in-out hover:text-[#E8604C] duration-300">
            <Image src={icon3} alt="es1" className="w-10 " />
            <div className="">
          ...
          <div className="flex items-center gap-4 py-2 text-white transition-all ease-in-out hover:text-[#E8604C] duration-300">
            <Image src={icon2} alt="es1" className="w-10 " />
            <div>
        ...
        <div className="overflow-hidden p-4">
          <Image
            src={es1}
            alt="es1"
            className="opacity-80 h-fit hover:scale-105 transition-all duration-300"
          />
        </div>
      </div>
    </div>

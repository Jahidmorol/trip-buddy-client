...
const Footer = () => {
  return (
    <div>
      <footer>
        <div className="bg-[#0C0F13] py-4 text-gray-400 ">
          <div className="container px-4 mx-auto">
            <div className="-mx-4 flex flex-wrap justify-between">
              ...
              <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
                ...
                <a
                  href="#"
                  className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full hover:text-[#e8604c] hover:border-[#e8604c]"
                >
                  <svg
                    className="w-4 h-4 fill-current"
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="bg-[#952514] py-4 text-gray-100">
